...
<\body>
  <active*|<\src-title>
    <src-package-dtd|title-thesis|1.1|header-title|1.1>

    <\src-purpose>
      Titles for the bachelor thesis for Anhui university.
    </src-purpose>

    <src-copyright|2020--2021|Hammer Hu>
  ...
  <assign|doc-make-titlelike|<macro|body|<surround||<vspace|2fn>|<doc-title-block|<arg|body>>>>>
